    ...
    >
      ...
      >
        ...
        <section className="mb-8">
          <h2 className="text-xl font-serif mb-4">1. Our Vision</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <h3 className="text-lg font-serif mb-3">2.1 Text-First Approach</h3>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-serif mb-3">
            2.2 Fragment-Based Communication
          </h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-serif mb-4">
            3. Express Yourself Through Fragments
          </h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-serif mb-4">
            4. A Safe Space for Authentic Expression
          </h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-serif mb-4">7. Getting Started</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-serif mb-4">8. Ready to Join?</h2>
          <p className="mb-4">
